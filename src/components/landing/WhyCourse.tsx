...
const reasons = [
  ...
  },
  {
    ...
    desc: "Front, Mobile, Backend, — Toshkent ish e'lonlarida eng ko'p so'raladigan to'plam.",
    metric: "6",
        ...
        >
          <div className="flex items-center gap-3 flex-1">
            ...
            <p className="text-sm sm:text-base">
              <span className="font-semibold">1 dars yoqmasa pul qaytarish kafolati.</span>{" "}
