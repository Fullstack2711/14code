...
const faqs = [
  {
    ...
    a: "Ha, agar har kuni 4-6 soat to'liq bag'ishlasangiz. Biz quruq gapga vaqt sarflamaymiz — faqat ishga kerakli bilim. 100+ talaba bunga amin bo'lgan.",
  },
  {
  ...
  },
  {
    ...
    a: "Pro tarif bilan: CV/LinkedIn correction, mock interview, ish e'lonlari va to'g'ridan-to'g'ri kompaniyalarga tavsiya. 70+ talabamiz allaqachon ishga kirgan.",
  },
  {
