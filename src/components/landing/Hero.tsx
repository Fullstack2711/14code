        ...
        <div className="grid lg:grid-cols-[1.15fr_1fr] gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="mt-6 text-base sm:text-lg text-muted-foreground max-w-xl leading-relaxed text-pretty">
              100% amaliy kurs. Real loyihalar, mentor qo'llab-quvvatlashi va hamkor kompaniyalarga tavsiya
              etish — <span className="text-foreground font-medium">14 kunda</span>.
            </p>
            ...
            <div className="mt-7 flex flex-wrap items-center gap-x-5 gap-y-2 text-xs text-muted-foreground">
              <div className="flex items-center gap-1.5">
                ...
                <span>1 darsda pul yoqmasa qaytarish</span>
              </div>
              <div className="flex items-center gap-1.5">
                <Check className="w-3.5 h-3.5 text-primary" />
                Sertifikat
