    ...
    <section className="relative py-24 sm:py-32">
      <div className="mx-auto max-w-6xl px-4">
        ...
        >
          ...
          <div className="relative glass-card-strong rounded-[1.5rem] sm:rounded-[2rem] p-8 sm:p-14">
            ...
            <h2 className="text-4xl sm:text-6xl font-bold tracking-tight leading-[1.05]">
              ...
              <br />
              <span className="text-gradient-electric">14 kundan keyin</span>
              <br />
              <span className="text-foreground">hayotingiz o'zgaradi.</span>
            </h2>

            <p className="mt-6 text-lg text-muted-foreground max-w-xl mx-auto">
              Eng yaxshi vaqt — hozir. Ikkinchi yaxshi vaqt — hech qachon.
            </p>
            ...
            <div className="mt-10">
              <Button
                onClick={onCtaClick}
                size="lg"
                className="group bg-gradient-to-r from-primary to-primary-glow text-primary-foreground hover:opacity-95 rounded-2xl h-15 px-10 text-lg font-semibold shadow-[0_15px_50px_-10px_oklch(0.68_0.20_254/0.8)] transition-all hover:shadow-[0_20px_60px_-10px_oklch(0.68_0.20_254/1)] hover:-translate-y-1"
              >
                Ro'yxatdan O'tish
            ...
            <p className="mt-5 text-xs text-muted-foreground">
              3 kun ichida pul qaytarish kafolati · Bepul konsultatsiya
            </p>
          </div>
        </motion.div>
      </div>
