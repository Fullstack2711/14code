...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Pro tarif bilan: CV/LinkedIn correction, mock interview, ish e'lonlari va to'g'ridan-to'g'ri kompaniyalarga tavsiya. 70+ talabamiz allaqachon ishga kirgan.",
      },
    },
    {
      "@type": "Question",
  ...
  head: () => ({
    meta: [
      { title: "14 Kunda Junior Developer — Premium Dasturlash Kursi | Code14" },
      {
        name: "description",
        content:
          "2 haftada HTML, CSS, JavaScript, React, Git va Portfolio bilan Junior Developer bo'ling. 100+ talaba, 70+ ishga kirgan, 95% mamnunlik. Hoziroq boshlang.",
      },
      {
        name: "keywords",
        content:
