...
const appCss = "/assets/styles-BoF061l4.css";
const logo = "/assets/logo-CvZCB362.png";
function r(e) {
  var t, f, n = "";
...
function InitialLoadingSplash({ durationMs = 5e3, className }) {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 -m-14", children: Array.from({ length: 12 }).map((_, i) => {
...
const Route$1 = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Code14  -  14kunda  Junior bo'lib birinchi ishingizni toping"
      },
      ...
      {
        property: "og:image",
        content: "https://storage.googleapis.com/gpt-engineer-file-uploads/6WKtDfWdQ8XIA15at2sIHCOvO9t1/social-images/social-1777359389362-ChatGPT_Image_Apr_28__2026__11_55_07_AM-removebg-preview.webp"
      },
      {
        name: "twitter:image",
        content: "https://storage.googleapis.com/gpt-engineer-file-uploads/6WKtDfWdQ8XIA15at2sIHCOvO9t1/social-images/social-1777359389362-ChatGPT_Image_Apr_28__2026__11_55_07_AM-removebg-preview.webp"
...
function RootShell({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { lang: "uz", className: "dark", children: [
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(InitialLoadingSplash, { durationMs: 5e3 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {})
  ] });
}
const $$splitComponentImporter = () => import("./index-BvNrW45G.mjs");
...
const organizationSchema = {
  ...
  url: SITE_URL,
  logo: OG_IMAGE,
  description: "14 kunlik premium intensiv dasturlash kursi. Junior Developer bo'lib ishga kirish uchun amaliy bilim.",
...
const courseSchema = {
  ...
  description: "HTML, CSS, JavaScript, React, Git, Portfolio va Interview bilan 14 kunda Junior Frontend Developer bo'lib ishga kirish kursi.",
  provider: {
    "@type": "EducationalOrganization",
    name: "Code14",
    sameAs: SITE_URL
...
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "2 haftada HTML, CSS, JavaScript, React, Git va Portfolio bilan Junior Developer bo'ling. 1200+ talaba, 300+ ishga kirgan, 95% mamnunlik. Hoziroq boshlang."
    }, {
      name: "keywords",
      content: "dasturlash kursi, junior developer, frontend, react, javascript, 14 kun, ishga kirish, code14, html, css"
    }, {
      property: "og:title",
      content: "14 Kunda Junior Developer — Code14"
    }, {
      property: "og:description",
      content: "Premium intensiv dasturlash kursi. 14 kunda real loyihalar, portfolio va interview tayyorlik bilan ishga tayyor bo'ling."
    }, {
      property: "og:type",
      content: "website"
    }, {
